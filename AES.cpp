...
int main(){
    ...
    do{
        ...
        if(choice == "1"){
            ...
            fclose(fpk);
            fpc = fopen("ciphertexthex.txt", "r");
            for(int i = 0; i < 16; i++){
                fscanf(fpc, "%x", &cipher_text[i]);
            }
            ///for(int i = 0; i < 16; i++){
            ...
            ///printf("\n");
            fclose(fpc);
            cout<<"The decryption is being performed...\nThe decrypted text will be stored in \"plaintextresult.txt\" file\n\n\n";
            plain_result = "";
            decrypt();
        }
        else if(choice == "3"){
